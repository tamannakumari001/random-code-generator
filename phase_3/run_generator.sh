...
if [[ $# -lt 1 ]]; then
    echo "Usage: $0 SEED [--statements N] [--expr-depth N] [--control-depth N]" >&2
    echo "Example: $0 73 --statements 10 --expr-depth 3 --control-depth 2" >&2
    exit 1
fi
...
binary_file="/tmp/phase3_random_code_generator"
